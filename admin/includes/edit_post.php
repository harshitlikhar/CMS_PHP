<?php
  ...
  if (isset($_GET['p_id'])) {
    ...
    $query = "SELECT * FROM posts WHERE post_id = {$po_id}";
    ...
    if (isset($_POST['update_post'])) {
     ...
     if (empty($post_image)) {
        $query = "SELECT * FROM posts WHERE post_id = $po_id";
        $res_img = mysqli_query($connection,$query);
...
$query .= "WHERE post_id ={$po_id}";
 ...
 if(!$res_upd){
          ...
          echo " <div class='alert alert-success'>  
                  <strong>Success!</strong> Post is Updated : " . " <a href='../post.php?p_id={$po_id}'>View Post!</a> Or <a href='posts.php'>View All Post!</a>
                 </div>";
        }
...
<form action="" method="post" enctype="multipart/form-data">    
      ...
      <div class="form-group">
        <label for="categories">Post Categories</label> <br/>
    ...
    <div class="form-group">
      <label for="status">Post Image</label> <br/>
